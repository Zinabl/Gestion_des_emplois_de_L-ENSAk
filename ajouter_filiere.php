...
<nav>
    ...
    <form method="GET" action="#">
      <div class="banner">
      <h1>Ajouter Filière &nbsp</h1>
        <img src="images/admin2.jpg" alt="photo">
      </div>
      <br/>
      <fieldset>
        <legend>Ajouter Filière</legend>
        <div class="colums">
          <div class="item">
            <label for="nom">Filière<span id="etoile">*</span></label>
            <input id="fname" type="text" name="filiere" placeholder="Génie..." >
          </div>
      ...
      <div class="btn-block">
      <button type="order" name="enregistrer">Ajouter</button>
      </div>
    </form>
    </div>
  </body>
...
<?php
  ...
  $sql="INSERT INTO `filiere`(`lib_filiere`)values('$filiere')";
